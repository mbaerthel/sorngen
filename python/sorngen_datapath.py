...
class sornInstance:
  ...
  def __init__(self, env, name, function, inputList):
      ...
      # 2/ register instance to environment
...
class sornPort:
  ...
  def __init__(self, env):
      ...
      self.instances = []
      self.datapath  = []
      # 2/ register ports to environment
...
def register(type0, type1):
    ...
    if not (type(type1) is sornPort or type(type1) is sornInstance or type(type1) is sornNet):
        ...
        sys.exit(0)
    # 2/ catch invalid combination of types
